                ...
                <div class="card-body">
                    <form id="form-register" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cellphone" type="cellphone" class="form-control @error('cellphone') is-invalid @enderror" name="cellphone" required autocomplete="new-cellphone" value="{{old('cellphone')}}">
